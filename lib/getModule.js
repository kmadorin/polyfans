...
export const getModule = (
	...
	switch (name) {
		...
		case 'FollowersOnlyCollectModule':
			return {
				name: 'Followers Only Collect',
				hasParam: false,
				config: {
				...
				type: 'collectModule',
				helper:
					'The Followers Only Collect Module allows any follower to collect the publication this module is attached to.'
			}
...
export const followersOnlyFeeData = {
	amount: { currency: '', value: '' },
	collectLimit: '',
	recipient: '',
	referralFee: 0,
